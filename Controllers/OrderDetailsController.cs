...
using project2_27593657.Models;

namespace project2_27593657.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class OrderDetailsController : ControllerBase
    {
        private readonly CMPG_Project2_27593657Context _context;

        public OrderDetailsController(CMPG_Project2_27593657Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'CMPG_Project2_27593657Context.OrderDetails'  is null.");
          }
